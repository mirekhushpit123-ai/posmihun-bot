...
JOKES = [
    ...
    "Приходить кум до кума: — Куме, а що це у вас собака так виє? — А це він у мене співати вчиться!",
...
async def job_morning():
    ...
    await bot.send_photo(chat_id=CHAT_ID, photo=photo, caption="☀️ *Доброго ранку, чате!* Бажаю усім неймовірного натхнення та продуктивного дня! ☕️✨")
